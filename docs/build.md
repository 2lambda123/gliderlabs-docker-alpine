...
To build all the images simply run: $ ./build version/library-3.2/options versions/gliderlabs-3.2/options version/library-3.2/options versions/gliderlabs-3.2/options
